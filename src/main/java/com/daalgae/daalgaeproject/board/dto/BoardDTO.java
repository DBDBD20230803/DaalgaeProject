...
public class BoardDTO {
    ...
    public BoardDTO(Long no, Integer type, Long categoryCode, CategoryDTO category, String title, String body, Long writerMemberNo,
                    //MemberDTO writer,
                    int count, Date createdDate, Date modifiedDate, String status, List<AttachmentDTO> attachmentList) {
        this.no = no;
        this.type = type;
