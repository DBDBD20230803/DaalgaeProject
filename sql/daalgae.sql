...
ALTER TABLE USER_REPORT ADD COLUMN REF_POST_CODE INTEGER;
ALTER TABLE USER_REPORT ADD COLUMN REF_POST_REPLY_CODE INTEGER;
ALTER TABLE USER_REPORT ADD FOREIGN KEY (REF_POST_CODE) REFERENCES POST_INFO(POST_CODE);
ALTER TABLE USER_REPORT ADD FOREIGN KEY (REF_POST_REPLY_CODE) REFERENCES POST_REPLY(POST_REPLY_CODE);
